...
Q_DIR = os.path.join(os.path.dirname(__file__), "Q2")
PYTHON = sys.executable
TARGET = os.path.join(os.path.dirname(__file__), "q2.py")

def test_q2_cases():
    """
    Run all Q2 test cases using the shared utility functions.
    """

...
Q_DIR = os.path.join(os.path.dirname(__file__), "Q3")
PYTHON = sys.executable
TARGET = os.path.join(os.path.dirname(__file__), "q3.py")

def test_q3_cases():
    """
    Run all Q3 test cases using the shared utility functions.
    """
